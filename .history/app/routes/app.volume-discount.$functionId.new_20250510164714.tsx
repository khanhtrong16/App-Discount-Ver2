                    ...
                    <Grid>
                      <Grid.Cell columnSpan={{ xs: 6, sm: 4, md: 4 }}>
                        ...
                        <TextField
                          ...
                          autoComplete="on"
                          {...configuration.quantity.map((item) => item.tier01)}
                        />
                        <TextField
                          label="Discount percentage"
                          autoComplete="on"
                          {...configuration.percentage.map(
                            (item) => item.tier01,
                          )}
                          suffix="%"
                        />
                      ...
                      <Grid.Cell columnSpan={{ xs: 6, sm: 4, md: 4 }}>
                        ...
                        <TextField
                          label="Minimum quantity"
                          autoComplete="on"
                          {...configuration.quantity.map((item) => item.tier02)}
                        />
                        <TextField
                          label="Discount percentage"
                          autoComplete="on"
                      ...
                      <Grid.Cell columnSpan={{ xs: 6, sm: 4, md: 4 }}>
                        ...
                        <TextField
                          label="Minimum quantity"
                          autoComplete="on"
                          {...configuration.quantity.map((item) => item.tier03)}
                        />
                        <TextField
                          label="Discount percentage"
                          autoComplete="on"
