      ...
      <Layout>
          ...
          <Form method="post">
            <BlockStack align="space-around" gap="200">
              ...
              <ActiveDatesCard
                startDate={{
                  ...startDate,
                  value: formatDateToString(startDate.value) as any,
                }}
                endDate={{
                  ...endDate,
                  value: formatDateToString(endDate.value) as any,
                }}
        ...
        <Layout.Section variant="oneThird">
          <SummaryCard
            ...
            activeDates={{
              startDate: formatDateToString(startDate.value) as string,
              endDate: formatDateToString(endDate.value),
            }}
          />
        </Layout.Section>
        <Layout.Section>
