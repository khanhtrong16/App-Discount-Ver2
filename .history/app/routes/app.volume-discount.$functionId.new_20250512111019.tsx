  ...
  const {
    ...
    onSubmit: async (form) => {
      const discount = {
        ...
        configuration: {
          quantity: 
          tier.forEach((item ) => {return {
            [`tier0${item}`]: parseInt(form.configuration.quantity?.[`tier0${item}`]),
          }})
          percentage: {
            tier01: parseInt(form.configuration.percentage.tier01),
            tier02: parseInt(form.configuration.percentage.tier02),
            tier03: parseInt(form.configuration.percentage.tier03),
          },
        },
