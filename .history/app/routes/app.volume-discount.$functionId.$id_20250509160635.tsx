...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const response = await admin.graphql(
    `#graphql
   query getDiscountById() {
    discountNode(id: "gid://shopify/DiscountNode/1531474346036") {
    id
    discount {
      ... on DiscountCodeApp {
        title
  ...
  console.log("đã chạy lại");
  console.log("Đây là datas", datas);
  const metafields = datas.data.discountNode.metafields.edges[0].node;
  const discount = datas.data.discountNode.discount;
  console.log("Đây là discount", discount);
  console.log("Đây là metafields", metafields);
